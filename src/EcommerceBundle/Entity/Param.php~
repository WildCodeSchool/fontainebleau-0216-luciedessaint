...
class Param
{
     ...
     * Set prmIdtva
     *
     * @param \EcommerceBundle\Entity\Tva $prmIdtva
     * @return Param
     */
    public function setPrmIdtva(\EcommerceBundle\Entity\Tva $prmIdtva = null)
    {
        $this->prmIdtva = $prmIdtva;
     ...
     */
    public function getPrmIdtva()
    {
        return $this->prmIdtva;
    }
}
